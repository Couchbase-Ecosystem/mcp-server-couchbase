...
| **Query and Indexing** | `run_sql_plus_plus_query`, `list_indexes`, `get_index_advisor_recommendations` |
...
- [Introducing the Couchbase MCP Server for AI Agents](https://www.couchbase.com/blog/introducing-couchbase-mcp-server-ai-agents/) — Blog post and video walkthrough.
