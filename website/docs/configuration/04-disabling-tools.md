...
:::warning
Disabling tools alone does not guarantee that certain operations cannot be performed. The underlying database user's **RBAC (Role-Based Access Control)** permissions are the authoritative security control.
