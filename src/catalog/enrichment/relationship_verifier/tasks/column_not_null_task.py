...
class ColumnNotNullTask:
    ...
    def _build_task_id(self) -> str:
        return f"column_not_null__{_normalize_name(self.collection)}__{_normalize_name(self.column)}"
    ...
    def _sdk_fallback(
        ...
        *,
        ...
        return {"null_count": 1 if has_null_or_missing else 0}
                ...
                if is_timeout_error(error_text):
                    try:
                        return self._sdk_fallback(
                            ...
                            "sample_size": value_set_timeout_sample_size,
                            "sampled_query": "sdk_sampling(column_not_null)",
                        }
