...
async def connect_to_couchbase_cluster_async(
    connection_string: str,
    username: str,
    password: str,
    ca_cert_path: str | None = None,
    ...
    try:
        ...
        cluster = AsyncCluster(connection_string, options)  # type: ignore
...
def connect_to_bucket_async(cluster: AsyncCluster, bucket_name: str) -> AsyncBucket:
    """Connect to a bucket and return the bucket object if successful.
    If the operation fails, it will raise an exception.
    """
    try:
